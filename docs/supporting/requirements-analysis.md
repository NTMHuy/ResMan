...
_Inventory và Information Flow hỗ trợ luồng vận hành trên._
...
_Các requirement này có giá trị cao nhưng không trực tiếp tạo ra luồng Order $\rightarrow$ Kitchen._
...
- **A-01 — Order $\rightarrow$ Kitchen là luồng vận hành cốt lõi**
  - **Risk:** High
...
_Ước lượng dưới đây là relative estimation, dùng để so sánh mức độ phức tạp tương đối._
...
| **Aligned with PRD**        | Pass    | PR-01 $\rightarrow$ PR-08 được trace về PRD       |
...
_\* Các đánh giá này vẫn cần được Human Review xác nhận trước khi xem là final._
